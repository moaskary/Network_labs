...
![Topology and successful pings](screenshots/topology-and-pings.png)
...
|--------|-------------|------|--------|
| PC0 (192.168.1.x) | PC1 (192.168.1.x) | same subnet | ✅ success |
| PC0 (192.168.1.x) | PC2 (192.168.2.x) | cross subnet | ✅ success |
| PC1 (192.168.1.x) | PC3 (192.168.2.x) | cross subnet | ✅ success |
| PC2 (192.168.2.x) | PC3 (192.168.2.x) | same subnet | ✅ success |
...
![SW1 MAC address table](screenshots/sw1-mac-table.png)

**PC0 ARP table — the gateway's MAC is cached for remote traffic:**
![PC0 ARP showing gateway MAC](screenshots/pc0-arp-gateway.png)
